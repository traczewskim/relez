...
const getAllTags = (owner, repo) => {
    ...
    if(tags.length === 0) {
        console.error('### Not Tags in repository. Create tag manually.');
        process.exit(1);
    }
...
const findNextTag = (currentTag, type) => {
...
module.exports = { findLatestTag, findCurrentTag, getAllTags, findNextTag };